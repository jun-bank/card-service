package com.jun_bank.card_service.global.aop;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("execution(* com.jun_bank.card_service.domain..presentation..*Controller.*(..))")
    public void controllerPointcut() {}

    /**
     * Service 패키지 내 모든 public 메서드
     */
    @Pointcut("execution(* com.jun_bank.card_service.domain..application.service..*Service.*(..))")
